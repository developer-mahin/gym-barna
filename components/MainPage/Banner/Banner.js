    ...
    return (
        <div className="bg-gradient-to-r from-[#FCF2EF] to-[#FEFDFF] lg:pt-[194px] pt-[60px] pb-[60px]">
            <div className="container mx-auto grid md:grid-cols-2 grid-cols-1 gap-32 items-end px-6">
                <div>
                    <h2 className="lg:text-[56px] text-[28px] text-[#262524] font-medium lg:leading-[65px]">Healthy in side <br /> <span className="text-[#8382EB]">fresh</span> out side</h2>
                    <div className="py-6">
                    ...
                    <div className="grid grid-cols-2 gap-9">
                        <button className="flex items-center gap-20 bg-[#264373] text-white py-4 px-6 rounded-xl drop-shadow-2xl">
                            <span>Get started</span>
                            <IoIosArrowDroprightCircle className="text-3xl" />
                        </button>
                        <button className="flex items-center bg-[#fff] gap-4 py-4 px-6 rounded-xl drop-shadow-2xl">
                            <AiFillPlayCircle className="text-3xl text-[#264373]"></AiFillPlayCircle>
                ...
                <div className="relative">
                    ...
                    <div className="absolute bottom-0">
                        <img src="https://i.ibb.co/Dzy1HF1/Group-3868-removebg-preview.png" className="drop-shadow-2xl" alt="" />
                    </div>
                    ...
                    <div className="absolute top-5 lg:-top-16 left-0 lg:left-16 bg-white drop-shadow-2xl py-[10px] px-5 rounded-xl flex items-center w-[150px] lg:w-[187px]">
                        <div>
